...
// *********************************************************************//
  ITextSelectionDisp = dispinterface
    ...
    function MoveStartUntil(var Cset: OleVariant; Count: Integer): Integer; dispid 552;
    function MoveEndUntil(var Cset: OleVariant; Count: Integer): Integer; dispid 553;
    function FindText(const bstr: WideString; cch: Integer; aFlags: Integer): Integer; dispid 560;
    function FindTextStart(const bstr: WideString; cch: Integer; aFlags: Integer): Integer; dispid 561;
    function FindTextEnd(const bstr: WideString; cch: Integer; aFlags: Integer): Integer; dispid 562;
    function Delete(Unit_: Integer; Count: Integer): Integer; dispid 563;
    procedure Cut(out pVar: OleVariant); dispid 564;
    procedure Copy(out pVar: OleVariant); dispid 565;
    procedure Paste(var pVar: OleVariant; Format: Integer); dispid 566;
    function CanPaste(var pVar: OleVariant; Format: Integer): Integer; dispid 567;
    function CanEdit: Integer; dispid 568;
    procedure ChangeCase(aType_: Integer); dispid 569;
    procedure GetPoint(aType_: Integer; out px: Integer; out py: Integer); dispid 576;
    procedure SetPoint(x: Integer; y: Integer; aType_: Integer; Extend: Integer); dispid 577;
    procedure ScrollIntoView(Value: Integer); dispid 578;
    function GetEmbeddedObject: IUnknown; dispid 579;
  end;
...
// *********************************************************************//
  ITextParaDisp = dispinterface
    ...
    procedure SetIndents(StartIndent: Single; aLeftIndent: Single; aRightIndent: Single); dispid 1057;
    procedure SetLineSpacing(aLineSpacingRule: Integer; aLineSpacing: Single); dispid 1058;
