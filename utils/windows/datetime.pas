...
begin
  ...
  dec(Year);
  result := int64(Year)*365 + int64(Year div 4) - int64(Year div 100) + int64(Year div 400) + int64(Day) - DateDelta;
end;
...
var
  uli:ULARGE_INTEGER;
begin
  uli.QuadPart:=(int64(Second)+int64(Minute)*60+int64(Hour)*60*60+int64(Day)*SecondsPerDay)*10*1000*1000;
