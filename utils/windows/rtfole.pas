...
function TRichEditOleCallback._AddRef: Longint; stdcall;
begin
  Inc(FRefCount);
  Result := FRefCount;
end;

function TRichEditOleCallback._Release: Longint; stdcall;
begin
  Dec(FRefCount);
  Result := FRefCount;
end;
...
function TRichEditOleCallback.QueryInsertObject(const clsid: TCLSID; const stg: IStorage; cp: Longint): HResult; stdcall;
begin
  Result := NOERROR;
end;
...
function TRichEditOleCallback.QueryAcceptData(const dataobj: IDataObject; var cfFormat: TClipFormat;
  reco: DWORD; fReally: BOOL; hMetaPict: HGLOBAL): HResult; stdcall;
begin
  Result := S_OK;
end;

function TRichEditOleCallback.ContextSensitiveHelp(fEnterMode: BOOL): HResult; stdcall;
begin
  Result := E_NOTIMPL;
end;

function TRichEditOleCallback.GetClipboardData(const chrg: TCharRange; reco: DWORD; out dataobj: IDataObject): HResult; stdcall;
begin
  Result := E_NOTIMPL;
end;

function TRichEditOleCallback.GetDragDropEffect(fDrag: BOOL; grfKeyState: DWORD; var dwEffect: DWORD): HResult; stdcall;
begin
  Result := E_NOTIMPL;
end;
...
{$IFDEF FPC}
function TImageDataObject.DAdvise(const formatetc: TFormatEtc; advf: dword; const advSink: IAdviseSink;
  out dwConnection: dword): HResult; stdcall;
{$ELSE}
function TImageDataObject.DAdvise(const formatetc: TFormatEtc; advf: longint; const advSink: IAdviseSink;
...
{$IFDEF FPC}
function TImageDataObject.DUnadvise(dwConnection: dword): HResult; stdcall;
{$ELSE}
function TImageDataObject.DUnadvise(dwConnection: longint): HResult; stdcall;
{$ENDIF}
begin
  Result := E_NOTIMPL;
end;

function TImageDataObject.EnumDAdvise(out enumAdvise: IEnumStatData): HResult; stdcall;
begin
  Result := E_NOTIMPL;
end;

{$IFDEF FPC}
function TImageDataObject.EnumFormatEtc(dwDirection: dword; out aenumFormatEtc: IEnumFormatEtc): HResult; stdcall;
{$ELSE}
function TImageDataObject.EnumFormatEtc(dwDirection: longint; out aenumFormatEtc: IEnumFormatEtc): HResult; stdcall;
{$ENDIF}
begin
  Result := E_NOTIMPL;
end;

function TImageDataObject.GetCanonicalFormatEtc(const formatetc: TFormatEtc; out formatetcOut: TFormatEtc): HResult; stdcall;
begin
  Result := E_NOTIMPL;
end;

function TImageDataObject.GetDataHere(const formatetc: TFormatEtc; out medium: TStgMedium): HResult; stdcall;
begin
  Result := E_NOTIMPL;
end;

function TImageDataObject.QueryGetData(const formatetc: TFormatEtc): HResult; stdcall;
begin
  Result := E_NOTIMPL;
end;
...
function TImageDataObject.GetData(const formatetcIn: TFormatEtc; out medium: TStgMedium): HResult; stdcall;
begin
...
{$IFDEF FPC}
function TImageDataObject.SetData(const formatetc: TFormatEtc; const medium: TStgMedium; fRelease: BOOL): HResult; stdcall;
{$ELSE}
function TImageDataObject.SetData(const formatetc: TFormatEtc; var medium: TStgMedium; fRelease: BOOL): HResult; stdcall;
{$ENDIF}
begin
