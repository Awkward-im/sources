...
function GetInfo(var SongInfo:tSongInfo; aflags:cardinal):integer;
var
  FFile:THANDLE;
  s:integer;
  p:PAnsiChar;
...
begin
  ...
  case cmd of
    ...
    WAT_CTRL_SEEK : SendMessage(wnd,WM_AIMP_COMMAND,WM_AIMP_STATUS_SET,
...
const
  plRec:tPlayerCell=(
    ...
    Notes    :'';
    flags    :WAT_OPT_APPCOMMAND or WAT_OPT_HASURL or WAT_OPT_WINAMPAPI;
  );
