...
function ReadMP3(Info:UIntPtr):boolean;
function ReadMPG(Info:UIntPtr):boolean;
...
procedure CheckVBR(var f:file; var hdr:tMP3FrameHdr);
var
  pos,apos:cardinal;
  sign:longint;
  frames:longint;
...
function SearchStart(var f:file; var l:array of byte):Boolean;
var
  CurPos:longint;
...
//  if l[0]<>$FF then
  ...
  WATSet(Info,siBitrate   ,hdr.Bitrate);
  WATSet(Info,siSamplerate,hdr.Samplerate div 1000);
  WATSet(Info,siLength    ,hdr.Length);
  if hdr.Channel=3 then
    WATSet(Info,siChannels,1)
  else
    WATSet(Info,siChannels,2);
  WATSet(Info,siVBR,ORD(hdr.isVBR));
    ...
    case BlockType of
      ...
      $1B3: begin // Video
        ...
        begin
          ...
          WATSet(Info,siWidth ,((l2b(l)[1] and $F0) shr 4)+(l2b(l)[0] shl 4));
          WATSet(Info,siHeight,((l2b(l)[1] and $0F) shl 8)+ l2b(l)[2]);
      ...
      0,$1B7,$1B9: break;
{
      ...
      $1C0: begin // audio
        ...
        begin
          ...
          WATSet(Info,siBitrate   , btable[version and 1][Layer-1][l2b(l)[2] shr 4]);
          WATSet(Info,siSamplerate,(stable[version][(l2b(l)[2] and $0C) shr 2]) div 1000);
          l:=l2b(l)[3] shr 6;
          if l=3 then
            l:=1
          else
            l:=2;
          WATSet(Info,siChannels,l);
//          if w>0 then inc(p,w);
        end;
//        else
          inc(p,w);
